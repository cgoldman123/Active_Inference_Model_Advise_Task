...
function FinalResults = advise_sim_fit(sim_data, field, params)
...
%     end
    ...
    % Each blsock is separate -- effectively resetting beliefs at the start of
    % each block. 
