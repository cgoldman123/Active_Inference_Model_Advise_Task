...
result = struct('percent_win_choose_other', percent_win_choose_other, ...
                ...
                %    'percent_win_choose_other_first', percent_win_choose_other_first, ...
                %    'percent_win_choose_other_second', percent_win_choose_other_second, ...
                %    'percent_lose_choose_same_first', percent_lose_choose_same_first, ...
                %    'percent_lose_choose_same_second', percent_lose_choose_same_second, ...
                %    'percent_choose_advisor_after_bad_advice_first', percent_choose_advisor_after_bad_advice_first, ...
                %    'percent_choose_advisor_after_bad_advice_second', percent_choose_advisor_after_bad_advice_second, ...
                %    'time_advisor_chosen_first', length(trials_got_advice(trials_got_advice <= 180)), ...
                %    'time_advisor_chosen_second', length(trials_got_advice(trials_got_advice > 180)));
end
